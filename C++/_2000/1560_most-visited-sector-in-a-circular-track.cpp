...
int main() {
    ...
    Solution solution;
    {
        ...
        vector<int> result = solution.mostVisited(4, input);
        cout << endl;
    }
    {
        vector<int> input = {2,1,2,1,2,1,2,1,2};
        vector<int> result = solution.mostVisited(2, input);
        cout << endl;
    }
    {
        vector<int> input = {1,3,5,7};
        vector<int> result = solution.mostVisited(7, input);
        cout << endl;
    }
    cout << "end";
