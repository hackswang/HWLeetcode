...
int main() {
    ...
    Solution solution;
    {
        bool result = solution.isCircularSentence("leetcode exercises sound elightful");
        cout << endl;
    }
    {
        bool result = solution.isCircularSentence("e");
        cout << endl;
    }
    {
        bool result = solution.isCircularSentence("Leetcode is cool");
        cout << endl;
    }
    cout << "end";
